              ...
              <div class="card bg-dark text-white" style="border-radius: 1rem;">
                <form method="POST" action="/" class="card-body p-5 text-center">
                    ...
                    <div class="mb-md-5 mt-md-4 pb-5">
                        ...
                        <h2 class="fw-bold mb-2 text-uppercase">Add job</h2>
                        <p class="text-white-50 mb-5"></p>
      
                        <div class="form-outline form-white mb-4">
                            <input type="text" id="typeEmailX" name="title" class="form-control form-control-lg" />
                            <label class="form-label" for="typeEmailX">Title</label>
                        </div>
      
                        <div class="form-outline form-white mb-4">
                            <input type="text" id="typePasswordX" name="position" class="form-control form-control-lg" />
                        ...
                        <div class="form-outline form-white mb-4">
                            <input type="text" id="typePasswordX" name="wage" class="form-control form-control-lg" />
                        ...
                        <button class="btn btn-outline-light btn-lg px-5" type="submit">Add Job</button>
